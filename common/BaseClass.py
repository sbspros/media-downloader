...
from tables.MediaBuilderConfig import MediaBuilderConfig
import platform
import traceback
...
class BaseClass:
    ...
    def __init__(self):
        ...
        try:
            ## Get config values
            self._config=MediaBuilderConfig()
            ...
            # ## Check database
            # sql_conn=SqlConnector(self._bc._config._schema_name)
            # tv=Tv()
            # if tv.is_created(sql_conn._conn)==False:
            #         tv.create_table(self._bc,sql_conn._conn)
